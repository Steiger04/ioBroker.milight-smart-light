  ...
  export default {
        ...
        items: [
          {
            ...
            subtitleRgbW8: 'Color flashes in red, green, blue, white, yellow, purple',
          ...
          },
          {
            ...
            avatar: 'M3',
            title: 'Mode 3',
            subtitleRgbW: 'Color flashes in red, green, blue, white, yellow, purple',
          ...
          },
          {
            ...
            avatar: 'M8',
            title: 'Mode 8',
            subtitleRgbW: 'Several colors fade into each other and then flash randomly',
    ...
    methods: {
      ...
      setEffectMode(payload) {
        this.UPDATE_DP_FROM_CLIENT({value: payload, dp: 'effectMode', delay: 500})
      }
    },
    computed: {
