...
function mslcommandsV6 (adapter, mslStatestore) {
  ...
  commandsV6.bridge.constructor.prototype.off = _.wrap (commandsV6.bridge.off, function (func, options) {
    ...
    if (options.val === false) {
      options.val = true
      // adapter.setStateAsync (_idOn, true, true)
  ...
  commandsV6.bridge.constructor.prototype.rgb = _.wrap (commandsV6.bridge.rgb, function (func, options) {
    ...
    return [
      _on,
      func.call (commandsV6.bridge, _rgb[0], _rgb[1], _rgb[2]),
      this.brightness (_brightness.val)
    ]
  })
  ...
  commandsV6.bridge.constructor.prototype.effectMode = _.wrap (commandsV6.bridge.effectMode, function (func, options) {
    const _idBnO = options.channelPath + 'brightnessOnly'
  ...
  commandsV6.rgbw.constructor.prototype.rgb = _.wrap (commandsV6.rgbw.rgb, function (func, options) {
    ...
    return [
      _on,
      func.call (commandsV6.rgbw, options.mslZoneNumber, _rgb[0], _rgb[1], _rgb[2]),
      this.brightness (options.mslZoneNumber, _brightness.val)
    ]
  })
  ...
  commandsV6.fullColor.constructor.prototype.whiteTemperature = _.wrap (commandsV6.fullColor.whiteTemperature, function (func, options, ...argv) {
    if (typeof options !== 'object') {
      return func (options, _kelvinToPercent (argv[ 0 ]))
    }

    return func(options.mslZoneNumber, _kelvinToPercent(options.val))

    function _kelvinToPercent (val) {
      let minK = 2700
      let maxK = 6500
      let minM = 0
      let maxM = 100
  ...
  commandsV6.fullColor.constructor.prototype.rgb = _.wrap (commandsV6.fullColor.rgb, function (func, options) {
    ...
    const _idHue = options.channelPath + 'hue'
    const _idSt = options.channelPath + 'saturation'
    const _idBn = options.channelPath + 'brightness'
    ...
    return [
      _on,
      ...func.call (commandsV6.fullColor, options.mslZoneNumber, _rgb[0], _rgb[1], _rgb[2]),
    ]
  })
  ...
  commandsV6.fullColor8Zone.constructor.prototype.on = _.wrap (commandsV6.fullColor8Zone.on, function (func, options) {
    if (typeof options !== 'object') {
      return func (options)
    }
  ...
  commandsV6.fullColor8Zone.constructor.prototype.off = _.wrap (commandsV6.fullColor8Zone.off, function (func, options) {
    if (typeof options !== 'object') {
      return func (options)
    }
  ...
  commandsV6.fullColor8Zone.constructor.prototype.whiteMode = _.wrap (commandsV6.fullColor8Zone.whiteMode, function (func, options) {
    if (typeof options !== 'object') {
      return func (options)
    }
  ...
  commandsV6.fullColor8Zone.constructor.prototype.nightMode = _.wrap (commandsV6.fullColor8Zone.nightMode, function (func, options) {
    const _idOn = options.channelPath + 'on'
    const _idOff = options.channelPath + 'off'
    const _idOnOff = options.channelPath + 'onoff'
  ...
  commandsV6.fullColor8Zone.constructor.prototype.whiteTemperature = _.wrap (commandsV6.fullColor8Zone.whiteTemperature, function (func, options, ...argv) {
    if (typeof options !== 'object') {
      return func (options, kelvinToPercent (argv[ 0 ]))
    }

    return func(options.mslZoneNumber, kelvinToPercent(options.val))

    function kelvinToPercent (val) {
      let minK = 2700
      let maxK = 6500
      let minM = 0
      let maxM = 100
  ...
  commandsV6.fullColor8Zone.constructor.prototype.brightness = _.wrap (commandsV6.fullColor8Zone.brightness, function (func, options, ...argv) {
    if (typeof options !== 'object') {
      return func (options, _.parseInt (argv[ 0 ]))
    }
  ...
  commandsV6.fullColor8Zone.constructor.prototype.saturation = _.wrap (commandsV6.fullColor8Zone.saturation, function (func, options, ...argv) {
    if (typeof options !== 'object') {
      return func (options, _.parseInt (argv[ 0 ]), argv[ 1 ])
    }
  ...
  commandsV6.fullColor8Zone.constructor.prototype.hue = _.wrap (commandsV6.fullColor8Zone.hue, function (func, options, ...argv) {
    if (typeof options !== 'object') {
      return func (options, _.parseInt (argv[ 0 ]), argv[ 1 ])
    }
  ...
  commandsV6.fullColor8Zone.constructor.prototype.rgb = _.wrap (commandsV6.fullColor8Zone.rgb, function (func, options) {
    const _hue = mslStatestore.getState(options.fullChannelPath + 'hue')
    const _saturation = mslStatestore.getState(options.fullChannelPath + 'saturation')
    const _brightness = mslStatestore.getState(options.fullChannelPath + 'brightness')
    ...
    return [
      _on,
      ...func.call (commandsV6.fullColor8Zone, options.mslZoneNumber, _rgb[0], _rgb[1], _rgb[2]),
    ]
  })

  // wrapper fullColor8Zone effectMode
  commandsV6.fullColor8Zone.constructor.prototype.effectMode = _.wrap (commandsV6.fullColor8Zone.effectMode, function (func, options) {
    const _idBnO = options.channelPath + 'brightnessOnly'
  ...
  commandsV6.fullColor8Zone.constructor.prototype.effectModeNext = _.wrap (commandsV6.fullColor8Zone.effectModeNext, function (func, options) {
    return [
      func (options.mslZoneNumber),
      this.brightnessOnly (options.mslZoneNumber, mslStatestore.getState(options.fullChannelPath + 'brightnessOnly').val)
    ]
  ...
  commandsV6.fullColor8Zone.constructor.prototype.effectSpeedUp = _.wrap (commandsV6.fullColor8Zone.effectSpeedUp, function (func, options) {
    return func (options.mslZoneNumber)
  })

  // wrapper fullColor8Zone effectSpeedDown
  commandsV6.fullColor8Zone.constructor.prototype.effectSpeedDown = _.wrap (commandsV6.fullColor8Zone.effectSpeedDown, function (func, options) {
    return func (options.mslZoneNumber)
  })

  // wrapper fullColor8Zone link
  commandsV6.fullColor8Zone.constructor.prototype.link = _.wrap (commandsV6.fullColor8Zone.link, function (func, options) {
    return func (options.mslZoneNumber)
  })

  // wrapper fullColor8Zone unlink
  commandsV6.fullColor8Zone.constructor.prototype.unlink = _.wrap (commandsV6.fullColor8Zone.unlink, function (func, options) {
    return func (options.mslZoneNumber)
  })
  ...
  commandsV6.fullColor8Zone.constructor.prototype.onoff = function (options) {
    const _idOn = options.channelPath + 'on'
    const _idOff = options.channelPath + 'off'
  ...
  commandsV6.fullColor8Zone.constructor.prototype.brightnessOnly = function (options, ...argv) {
    if (typeof options !== 'object') {
      return this.brightness (options, argv[ 0 ])
    }
