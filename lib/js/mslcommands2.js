...
function mslcommands2 (adapter, mslStatestore) {
    ...
    commands2.rgbw.constructor.prototype.rgb = _.wrap(commands2.rgbw.rgb255, function (func, options) {
        ...
        return [
            _on,
            ...func.call(commands2.rgbw, _rgb.r, _rgb.g, _rgb.b)
        ];
    });
    ...
    commands2.rgbw.constructor.prototype.effectSpeedUp = _.wrap(commands2.rgbw.effectSpeedUp, function (func) {
        return func();
    });

    // wrapper rgbw effectSpeedDown
    commands2.rgbw.constructor.prototype.effectSpeedDown = _.wrap(commands2.rgbw.effectSpeedDown, function (func) {
        return func();
    });
