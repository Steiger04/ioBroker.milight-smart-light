...
function mslcommands2 (adapter, mslStatestore) {
    ...
    commands2.rgbw.constructor.prototype.allOn = _.wrap(commands2.rgbw.allOn, async function (func) {
        return func();
    });

    // wrapper rgbw allOff -> in mslstate.js nicht aktiviert!
    commands2.rgbw.constructor.prototype.allOff = _.wrap(commands2.rgbw.allOff, async function (func) {
        return func();
    });
    ...
    commands2.rgbw.constructor.prototype.nightMode = _.wrap(commands2.rgbw.nightMode, async function (func, options) {
    ...
    commands2.rgbw.constructor.prototype.effectSpeedUp = _.wrap(commands2.rgbw.effectSpeedUp, async function (func) {
        return func();
    });

    // wrapper rgbw effectSpeedDown
    commands2.rgbw.constructor.prototype.effectSpeedDown = _.wrap(commands2.rgbw.effectSpeedDown, async function (func) {
        return func();
    });
    ...
    commands2.white.constructor.prototype.brightUp = _.wrap(commands2.white.brightUp, async function (func) {
        return func();
    });

    // wrapper white brightDown
    commands2.white.constructor.prototype.brightDown = _.wrap(commands2.white.brightDown, async function (func) {
        return func();
    });

    // wrapper white maxBright
    commands2.white.constructor.prototype.maxBright = _.wrap(commands2.white.maxBright, async function (func, options) {
    ...
    commands2.white.constructor.prototype.nightMode = _.wrap(commands2.white.nightMode, async function (func, options) {
        if (mslStatestore.getState(options.fullChannelPath + 'on').val === true) {
            await mslStatestore.setState({ dp: 'on', val: false, params: options });
            await mslStatestore.setState({ dp: 'off', val: true, params: options });
            await mslStatestore.setState({ dp: 'onoff', val: false, params: options });
    ...
    commands2.white.constructor.prototype.warmer = _.wrap(commands2.white.warmer, async function (func) {
        return func();
    });

    // wrapper white cooler
    commands2.white.constructor.prototype.cooler = _.wrap(commands2.white.cooler, async function (func) {
        return func();
    });
